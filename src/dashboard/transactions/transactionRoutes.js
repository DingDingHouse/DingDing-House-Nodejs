...
transactionRoutes.get("/all", checkUser_1.checkUser, (0, checkRole_1.checkRole)(["admin", "company"]), transactionController.getAllTransactions);
transactionRoutes.get("/", checkUser_1.checkUser, (0, checkRole_1.checkRole)(["admin", "company", "master", "distributor", "subdistributor", "store"]), transactionController.getTransactions);
