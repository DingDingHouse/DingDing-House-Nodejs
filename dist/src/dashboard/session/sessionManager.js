        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (platformSession) {
                    ...
                    let existingSession = yield redisClient_1.pubClient.get(`socket:${playerId}`);
                    if (existingSession) {
                        ...
                        if (sessionData.gameSocketId) {
                            ...
                            yield redisClient_1.pubClient.del(`socket:${playerId}`);
                        }
                    }
                }
            }
            ...
            try {
                ...
                if (platformSession && platformSession.currentGameSession) {
                    ...
                    if (existingSession) {
                        ...
                        yield redisClient_1.pubClient.set(`socket:${playerId}`, JSON.stringify(sessionData));
